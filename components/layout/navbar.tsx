...
interface NavbarProps {
  ...
  /** Aluno: oculta busca e notificações administrativas */
  variant?: "staff" | "aluno"
}

export function Navbar({ title, subtitle, action, variant = "staff" }: NavbarProps) {
  const { isStaff, loading } = useIsStaff()
  const hideAdminUi = variant === "aluno" || (!loading && !isStaff)
  return (
    <header
